...
ckp_path = 'exp/QP37_swin&multires_3_l2finetune/ckp_520000.pt'  # trained at QP37, LDP, HM16.5

raw_yuv_path = '/data/cws/dataset/LDV_MFQE/test_18/raw/Kimono_1920x1080_240.yuv'
lq_yuv_path = '/data/cws/dataset/LDV_MFQE/test_18/HM16.5_LDP/QP37/Kimono_1920x1080_240.yuv'
...
outlog='./details/'+'OURS_'+vname+'.txt'
def main():
    # ==========
