...
from utils.deep_learning import CharbFFTLoss,CharbonnierLoss,FFTLoss
from torch import nn
from tqdm import tqdm
from utils.PeaksValleys import detectPeaksValleys
import random
import pandas as pd
...
def receive_arg():
    ...
    parser.add_argument(
        '--opt_path', type=str, default='option_R3_mfqev2_swinunetres_1G.yml',
...
if __name__ == '__main__':
    ...
    randItems = [20,19,18,17,21,19,18,16]
    data = {
        'Numbers': randItems
    }
    df = pd.DataFrame(data=data)
    X= detectPeaksValleys(df['Numbers'], 1, 3)
    print(detectPeaksValleys(df['Numbers'], 1, 3))